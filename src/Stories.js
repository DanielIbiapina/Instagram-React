...
export default function Stories() {
    const story1 = <Story imagem="./meowed.svg" usuario="9gag" />
    const story2 = <Story imagem="./meowed.svg" usuario="9gag" />
    const story3 = <Story imagem="./meowed.svg" usuario="9gag" />
    const story4 = <Story imagem="./meowed.svg" usuario="9gag" />
    const story5 = <Story imagem="./meowed.svg" usuario="9gag" />
    const story6 = <Story imagem="./meowed.svg" usuario="9gag" />
    const story7 = <Story imagem="./meowed.svg" usuario="9gag" />
    const story8 = <Story imagem="./meowed.svg" usuario="9gag" />
